...
enum
{
    ...
    wxID_MENU_SETTINGS_PLAYER1_COMPUTER_PLAYS_NEGAMAX_ALPHA_BETA_STOCHASTIC,
    ...
    wxID_MENU_SETTINGS_PLAYER2_COMPUTER_PLAYS_NEGAMAX_ALPHA_BETA_STOCHASTIC,
...
private:
    ...
    static const std::string COMPUTER_PLAYER_PERFECT_NEGAMAX_ALPHA_BETA_STOCHASTIC;
